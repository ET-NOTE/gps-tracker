...
#define PIN_PWR_EN     6
#define BUILD_TAG      "14_a"   // [diagnostic] /diagnostic sketch ID
#define PIN_PWRKEY     7
#define PIN_DTR        10
#define PIN_BAT        3
...
#define BUZZER_ENABLED 0     // [14_a] 부저 끔 — GPIO1 PWM 잡음 가설 검증용
...
void setup() {
  ...
  pinMode(PIN_BUZZER, INPUT_PULLDOWN);  // [14_a] GPIO1 격리 — driven LOW 대신 high-Z pull-down
  noTone(PIN_BUZZER);
