// 13_1_motion_aware_tracker — OLED 제거 + 자동 정지 감지 sleep 버전
//
// 동작:
...
#define PIN_PWR_EN     6
#define BUILD_TAG      "14_d"   // [diagnostic] /diagnostic sketch ID
#define PIN_PWRKEY     7
#define PIN_DTR        10
#define PIN_BAT        3
